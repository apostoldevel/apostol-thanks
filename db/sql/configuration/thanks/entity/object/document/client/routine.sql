...
BEGIN
  ...
  INSERT INTO db.client (id, document, code, birthdate, birthplace, userid, phone, email, info)
  VALUES (uDocument, uDocument, pCode, pBirthDate, pBirthPlace, pUserId, pPhone, pEmail, pInfo)
...
BEGIN
  ...
  UPDATE db.client
     SET code = pCode,
         ...
         birthdate = CheckNull(coalesce(pBirthDate, birthdate, MINDATE())),
