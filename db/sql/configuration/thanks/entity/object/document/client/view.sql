...
CREATE OR REPLACE VIEW Client (Id, Document, Code, BirthDate, BirthPlace,
  UserId, UserName, FullName, ShortName, LastName, FirstName, MiddleName,
  Phone, Email, Info, EmailVerified, PhoneVerified, Picture,
  Locale, LocaleCode, LocaleName, LocaleDescription
)
AS
  SELECT c.id, c.document, c.code, c.birthdate, c.birthplace,
...
AS
  ...
  SELECT c.* FROM db.client c INNER JOIN access ac ON c.id = ac.object;
...
CREATE OR REPLACE VIEW ObjectClient (Id, Object, Parent,
  ...
  Code, Label, Description, BirthDate, BirthPlace,
  UserId, UserName, FullName, ShortName, LastName, FirstName, MiddleName,
  Phone, Email, Info, EmailVerified, PhoneVerified, Picture,
  Locale, LocaleCode, LocaleName, LocaleDescription,
...
AS
  SELECT t.id, d.object, o.parent,
         ...
         t.code, ot.label, dt.description, t.birthdate, t.birthplace,
